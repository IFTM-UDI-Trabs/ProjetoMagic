        ...
        <div class="princ">
            ...
            <form class="form" action="?op=1" method="POST">
                ...
                <div class="input">
                    ...
                    <input type="text" class="tconjuracao" name="tconjuracao" maxlength="1" placeholder="Digite o Tempo de Conjuração">
                </div>
...
//================================================= Caso der Erro ================================================
                    if ($erro == true){
                        ...
                        $texto_sql = "INSERT INTO magia (user, nome, escola, nivel, conjurador, ritual, tempoconj, alcance, componentes, duracao, descricao, descricaolvl, curtidas) VALUES ('$nome', '$nome_magia', '$escola', '$nivel', '$conjurador', '$ritual', '$tempoconj', '$alcance', '$componentes', '$duracao', '$desc', '$desclvl', '0')";
