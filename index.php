<html>
    ...
    <body>
        ...
        <div id="rpg" class="azul">
            <div class="texto">
                <h1>O que é RPG?</h1>
                <p class="txt">Role-Playing game, também conhecido como, RPG é um estilo de jogo em que os jogadores interpretam papéis de personagens, criando narrativas colaborativamente. O desenvolvimento do jogo depende puramente de um sistema de regras predeterminado, mas muitas vezes os jogadores preferem improvisar livremente.</p>
